...
const DocumentTableRow = ({ data }) => {
  ...
  return (
    <tr className="document-table-item" onMouseEnter={handleHover}
    onMouseLeave={handleHover}>
      ...
      <td className="d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex align-items-center">
            {data.status === 1 ? 
            <>
        <Button className={"me-2"} type={"text"}>Download file</Button>
        ...
        <Button type={"text"}>Upload document</Button>
         ...
         :
         <Button className={"opacity-0"} type={"text"}>A</Button>}
      </td>
    </tr>
  );
};
